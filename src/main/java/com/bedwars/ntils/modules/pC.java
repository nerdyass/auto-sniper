                ...
                for (NetworkPlayerInfo playerInfo : safePlayerInfoCollection) {
                    futures.add(executor.submit(() -> {
                        ...
                        if (blacklistedUsers.contains(ign)) {
                            ...
                            mc.thePlayer.addChatMessage(new ChatComponentText(prefix + EnumChatFormatting.RED + tabDisplayName + EnumChatFormatting.RED + " is BLACKLISTED!"));
                            return true;
                        }
                        ...
                        if (playerData != null) {
                            ...
                            if (fkdr >= getMinFKDR()) {
                                ...
                                mc.thePlayer.addChatMessage(new ChatComponentText(prefix + EnumChatFormatting.DARK_PURPLE + tabDisplayName + EnumChatFormatting.AQUA + " has FKDR: " + EnumChatFormatting.DARK_PURPLE + fkdr));
                                return true;
                            }
                        } else {
                            System.out.println(ign + " is NOT a valid Hypixel player.");
                            playSound("random.levelup", 1.0f, 1.0f);
                            mc.thePlayer.addChatMessage(new ChatComponentText(prefix + EnumChatFormatting.LIGHT_PURPLE + tabDisplayName + EnumChatFormatting.LIGHT_PURPLE + " is nicked!"));
                            return true;
                        }
                        return false;
                    }));
